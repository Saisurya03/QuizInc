    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (admin != null) {
                ...
                out.println("<div class='container'><h1 class='us'>Users</h1><br></div>");
                ...
                while (rs.next()) {
                    ...
                    out.println("<td class='td1'>" + rs.getInt("sroll") + "</td>");
                    out.println("<td class='td1'>" + rs.getString("sname") + "</td>");
                    out.println("<td class='td1'>" + rs.getString("email") + "</td>");
                    out.println("<td class='td1'>" + rs.getString("password") + "</td>");
                    out.println("<td class='td1'>" + rs.getString("grp") + "</td>");
                    out.println("<td class='td1'>" + rs.getString("sub") + "</td>");
                    out.println("<td class='td1'>student</td>");
                    out.println("<td class='td1'><a id='del' href='deleteUsers?op=delete&u=student&sid=" + rs.getInt("sid") + "'>delete</a></td></tr>");
                }

                while (rs1.next()) {
                    srno = srno + 1;
                    out.println("<tr class='td1'><td class='td1'>" + srno + "</td>");
                    out.println("<td class='td1'>" + rs1.getInt("troll") + "</td>");
                    out.println("<td class='td1'>" + rs1.getString("tname") + "</td>");
                    out.println("<td class='td1'>" + rs1.getString("email") + "</td>");
                    out.println("<td class='td1'>" + rs1.getString("password") + "</td>");
                    out.println("<td class='td1'>" + rs1.getString("grp") + "</td>");
                    out.println("<td class='td1'>" + rs1.getString("sub") + "</td>");
                    out.println("<td class='td1'>teacher</td>");
                    out.println("<td class='td1'><a id='del' href='deleteUsers?op=delete&u=teacher&tid=" + rs1.getInt("tid") + "'>delete</a></td></tr>");
                }
