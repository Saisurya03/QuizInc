        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<!DOCTYPE html> "
                   ...
                   out.println("<br>"
                    ...
                    + "     Enter Quiz Name: <input type='text' name='qname'><br><br>\n"
                    + "     Select Quiz type: <select name='qtype'>"
                    + "         <option value='poll'>Poll</option>"
                    + "         <option value='test'>Test</option></select><br><br>\n"
                    + "     Quiz timer: <select name='qtime'>"
                    + "         <option value='no'>No timer </option>"
                    + "         <option value=30>30 s/q  </option>"
                    + "         <option value=1>1 min/q </option>"
                    + "         <option value=2>2 min/q </option>"
                    + "         <option value=5>5 min/q </option></select><br><br>\n"
                    + "     Show Result: <input type='radio' name='res' value='yes'>Yes&nbsp<input type='radio' name='res' value='no'>No"
                    + "     <input type='hidden' name='sub' value='" + sub + "'>\n"
                    + "     <input type='hidden' name='grp' value='" + grp + "'>\n"
                    + "     <input type='hidden' name='tid' value='" + tid + "'><br><br>\n"
